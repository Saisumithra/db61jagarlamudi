...
router.get('/', function (req, res) {
 res.render('index', { title: 'flowerbouquet App', user : req.user });
});
router.get('/register', function(req, res) {
 res.render('register', { title: 'flowerbouquet App Registration'});
});
...
router.get('/login', function(req, res) {
 res.render('login', { title: 'flowerbouquet App Login', user : req.user });
});
